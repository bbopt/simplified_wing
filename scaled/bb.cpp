...
bool read_inputs ( const string & name     ,
  ...
  // scaling from [0;100] to the problem true bounds:

  b        = (        b / 100.0 ) * 15.0  + 30.0;
  Cr       = (       Cr / 100.0 ) *  6.0  +  6.0;
  lambda   = (   lambda / 100.0 ) *  0.22 +  0.28;
  alpha_r  = (  alpha_r / 100.0 ) *  4.0  -  1.0;
  alpha0_t = ( alpha0_t / 100.0 ) *  4.0  -  1.0;
  dr       = (       dr / 100.0 ) *  3.4  +  1.6;
  tr       = (       tr / 100.0 ) *  0.49 +  0.3;
